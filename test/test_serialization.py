...
from test.serialization import PollSerializer, AnswerSerializer, UuidRefSerializer

from jsoongia import Serializer, relationships
from test.generators import poll, answer


class BelongsToRelationshipTestCase(TestCase):
    def test_it_should_build_reference(self):
    ...
    def test_it_should_build_reference_with_only_one_include(self):
        belongs_to = relationships.BelongsTo()
...
class HasManyRelationshipTestCase(TestCase):
    def test_it_should_handle_a_has_many_relationship(self):
    ...
    def test_it_should_handle_a_has_many_with_only_one_include(self):
        has_many = relationships.HasMany('poll_id')
...
class SerializerTestCase(TestCase):
    ...
    def test_it_only_serializes_attributes(self):
        s = PollSerializer()
        data = poll(1)
    ...
    def test_it_should_serialize_lists_of_data(self):
        s = PollSerializer()
    ...
    def test_it_should_include_meta_at_root(self):
        s = PollSerializer()
    ...
    def test_it_should_handle_relationships(self):
    ...
    def test_it_should_handle_relationships_as_a_string(self):
    ...
    def test_it_should_allow_different_refs(self):
        s = UuidRefSerializer() 
